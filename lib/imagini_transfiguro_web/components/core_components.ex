defmodule ImaginiTransfiguroWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ImaginiTransfiguroWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ImaginiTransfiguroWeb.Gettext, "errors", msg, opts)
    # end
